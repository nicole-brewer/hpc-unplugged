...
Grids can be created by using a short program in Jupyter Notebook. This program is available at https://github.com/nicole-brewer/color-by-number. It produces a blank grid with numbers, as well as an answer key like the one below.

![color by number answer key](color_by_number_key.png)
